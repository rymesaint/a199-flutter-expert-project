...
class MovieRepositoryImpl implements MovieRepository {
  ...
  @override
  Future<Either<Failure, String>> saveWatchlist(dynamic movie) async {
    try {
      var result;
      if (movie is MovieDetail) {
        result =
            await localDataSource.insertWatchlist(MovieTable.fromEntity(movie));
      } else {
        result = await localDataSource
            .insertWatchlist(MovieTable.fromTvSeriesEntity(movie));
      }
      return Right(result);
  ...
  @override
  Future<Either<Failure, String>> removeWatchlist(dynamic movie) async {
    try {
      var result;
      if (movie is MovieDetail) {
        result =
        ...
        result = await localDataSource
            .removeWatchlist(MovieTable.fromTvSeriesEntity(movie));
      }
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
